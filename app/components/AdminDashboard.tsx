...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-gray-900">Espace Administrateur - Catalogue de composants</h2>
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Référence</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Description</th>
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Prix Unitaire (€)</th>
              ...
              <tr key={c.id_composant}>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm">
                  <input
                    ...
                    className="block w-24 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-gray-900 sm:text-sm px-2 py-1 border"
                  />
                </td>
